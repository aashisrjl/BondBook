...
exports.getPartnerSurprise = async(req,res)=>{
    try {
        ...
        res
        .status(200)
        .json({ message: "Surprise fetched successfully", surprises:SurpriseData });
...
router.route("/fetchAllSurprise").get(isAuthenticated,fetchAllSurprise);
router.route("/deleteSurprise/:id").delete(isAuthenticated,deleteSurprise);
router.route("/updateSurprise/:surpriseId").patch(isAuthenticated,updateSurprise);
